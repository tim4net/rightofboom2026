...
export const M365ConfigDriftDemo = ({ theme: t }) => {
  return (
    <div className="w-full h-full flex flex-col px-64 pt-60 pb-8">
      {/* Header */}
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="relative border-2 border-dashed border-amber-500/50 rounded-2xl p-6">
          {/* Label */}
          ...
          <div className="flex flex-col gap-4 pt-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 bg-emerald-500/10 border border-emerald-500/40 rounded-xl p-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 bg-amber-500/10 border border-amber-500/40 rounded-xl p-5">
                <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 bg-slate-700/30 border border-slate-600/40 rounded-xl p-5">
                <div className="flex items-center gap-6">
        ...
        {/* ═══ AI LAYER OUTLINE ═══ */}
        <div className="relative border-2 border-dashed border-purple-500/50 rounded-2xl p-6">
          {/* Label */}
          <div className="absolute -top-4 left-8 px-4 bg-slate-900">
          ...
          <div className="flex items-center gap-4 pt-2">
            ...
            <div className="flex-1 bg-purple-500/10 border border-purple-500/40 rounded-xl p-5">
              <div className="flex items-center gap-6">
        ...
        <div className="relative border-2 border-dashed border-amber-500/50 rounded-2xl p-6">
          ...
          <div className="flex items-center gap-4 pt-2">
            ...
            <div className="flex-1 flex gap-6">
              {/* Notify */}
              <div className="flex-1 bg-red-500/10 border border-red-500/40 rounded-xl p-5">
                <div className="flex items-center gap-4">
