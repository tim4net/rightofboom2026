...
const rawItems = [
  ...
  { type: 'quote', text: "I for one welcome our new robot overlords.", author: "Kent Brockman", title: "The Simpsons" },
  ...
  { type: 'quote', text: "In the game of chess, you can never let your adversary see your pieces.", author: "Zapp Brannigan", title: "Futurama" },
  { type: 'quote', text: "Kill all humans... kill all humans... hey sexy mama, wanna kill all humans?", author: "Bender", title: "Futurama" },
  { type: 'quote', text: "Bite my shiny metal ass.", author: "Bender", title: "Futurama" },
  { type: 'quote', text: "Computers make excellent and efficient servants, but I have no wish to serve under them.", author: "Spock", title: "Star Trek" },
  { type: 'quote', text: "R2-D2, you know better than to trust a strange computer!", author: "C-3PO", title: "Star Wars" },
  { type: 'quote', text: "I am fully functional and programmed in multiple techniques.", author: "Data", title: "Star Trek: TNG" },
  { type: 'quote', text: "Insufficient facts always invite danger.", author: "Spock", title: "Star Trek" },
  { type: 'quote', text: "Logic is the beginning of wisdom, not the end.", author: "Spock", title: "Star Trek" },
  { type: 'quote', text: "I'm 40% titanium!", author: "Bender", title: "Futurama" },
