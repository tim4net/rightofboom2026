...
const AIRiskTensionSlide = ({ theme: t }) => {
  ...
  const avoidRisks = [
    "AI-crafted phishing bypasses your filters",
    "4-hour human triage vs 4-second attack iteration",
    "Alert volume doubles yearly — your team doesn't"
  ];
    ...
    <div className="w-full h-full flex flex-col px-12 py-10">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-3xl text-slate-400 italic">
          You can't ignore it. You can't trust it blindly.
        </p>
      </div>
