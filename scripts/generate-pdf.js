...
const SLIDE_COUNT = 31; // Total slides (0-30) - includes 3 handoff slides for Roddy
const SKIP_SLIDES = []; // No slides skipped - mockups shown for demos
const DEMO_SLIDES = [3]; // AttackLab (index 3) has internal navigation - use PageDown to exit
